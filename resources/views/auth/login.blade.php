                    ...
                    <form action="{{ route('login') }}" method="POST" class="mt-8 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="email" type="email" class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Email" />
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div class="text-sm">
                                <a href="jajvascript:void(0);" class="text-blue-600 hover:underline font-semibold hover:cursor-not-allowed">Forgot your password?</a>
                            </div>
                        </div>
                        {{-- BUTTON --}}
                        <div class="!mt-8">
                        ...
                        <p class="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <a href="javascript:void(0);" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold hover:cursor-not-allowed">Register here</a></p>
                    </form>
                </div>
            </div>
        </div>
